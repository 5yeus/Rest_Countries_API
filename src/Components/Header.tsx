    ...
    return (
        <>
            <div className={`w-full shadow-lg ${ theme === 'light' ? 'bg-white shadow-slate-200/50': 'bg-ebonyclaydark shadow-custom'} laptop:h-[4rem] mobile:h-[5rem] flex flex-row py-6 fixed`}>
                <div className={`laptop:w-full font-nunito ${theme === 'light'? 'text-woodsmoke' : 'text-white'}  flex flex-row justify-between items-center laptop:px-[4rem] mobile:mx-auto mobile:gap-[5.8rem]`}>
